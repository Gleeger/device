...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			//dicky
            $order_subtotal_query = $this->db->query("SELECT value FROM " . DB_PREFIX . "order_total WHERE order_id = '" . (int)$order_id . "'" . "AND code = 'sub_total'");
            $subtotal = $order_subtotal_query->row['value'];
