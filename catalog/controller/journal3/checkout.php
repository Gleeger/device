...
class ControllerJournal3Checkout extends \Journal3\Opencart\Controller {
	...
	public function index() {
        ...
        //dicky
        $total_points = (int)$this->customer->getRewardPoints();
		$data['coupon_voucher_reward_block'] = $this->renderView('journal3/checkout/coupon_voucher_reward', array(
			...
			'entry_reward'   => sprintf($this->language->get('entry_reward'), $data['checkout_data']['order_data']['points']). ', Available Points: '.$total_points,
