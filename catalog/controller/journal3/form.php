		...
		try {
			...
			if ($errors) {
				...
				foreach ($data['items'] as $key => $value) {
					...
					//dicky
					if($value['type'] == 'select' && $value['value']=='Panduit'){
						$custom_to = 'estore@devicelect.com';
					}else if($value['type'] == 'select' && $value['value']=='Teledyne'){
						$custom_to = 'teledyne@devicelect.com';
					}
