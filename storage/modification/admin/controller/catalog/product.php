...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$data['filter_status'] = $filter_status;
				...
				$resultsman = $this->model_catalog_manufacturer->getManufacturers();
	...
	protected function getForm() {
		...
		foreach ($product_options as $product_option) {
			...
			if (isset($product_option['product_option_value'])) {
				...
				$option_specials = $this->model_catalog_product->getProductOptionValueSpecials($product_option_value['product_option_value_id']);

				$product_option_value_specials = array();

				foreach ($option_specials as $option_special) {
					$product_option_value_specials[] = array(
						'customer_group_id' => $option_special['customer_group_id'],
						'priority'          => $option_special['priority'],
						'price'             => $option_special['price'],
						'date_start'        => ($option_special['date_start'] != '0000-00-00') ? $option_special['date_start'] : '',
						'date_end'          => ($option_special['date_end'] != '0000-00-00') ? $option_special['date_end'] :  ''
					);
				}

				$product_option_value_data[] = array(
					'product_option_value_specials' => $product_option_value_specials,
