...
$this->load->model('extension/custverf');
			$this->model_extension_custverf->sendcustemail($customer_id);
		return $customer_id;
	}
...
if (isset($data['filter_custverf']) && $data['filter_custverf'] != '') {
				$implode[] = "custverf_confirm = " . (int)$data['filter_custverf'];
			}
