...
$this->load->model('extension/custverf');
			if($this->model_extension_custverf->getmodstatus() && isset($this->request->get['route']) && stristr($this->request->get['route'], 'account') && isset($this->session->data['custverf_customer_id']) && $this->session->data['custverf_customer_id']) {
				$this->document->addScript('catalog/view/javascript/custverf.js');
			}
		// Analytics
